...
class sysconf:
    ...
    def write_conf(self,nfile,content):
    ...
    def replace(self,section,content):
        ...
        self.beg = Template(begtpl).substitute(TAG=self.commenttag,NAME=section) 
        self.end = Template(endtpl).substitute(TAG=self.commenttag,NAME=section) 
